...
static void _do_wizard_command(int wiz_command, bool silent_fail)
{
    ...
    case '$':
        ...
        {
            mprf(P_("You now have %d gold piece.",
                    "You now have %d gold pieces.", you.gold),
                 you.gold);
        }
        break;
...
static bool _prompt_stairs(dungeon_feature_type ygrd, bool down)
{
    ...
    {
        string prompt = make_stringf(_("Are you sure you want to leave %s?"),
                                     branches[root_branch].longname);
        if (crawl_state.game_is_tutorial())
        {
            prompt += " ";
            prompt += _("This will make you lose the game!");
        }
...
static void _do_list_gold()
{
    ...
    {
        mprf(P_("You have %d gold piece.",
                "You have %d gold pieces.", you.gold),
             you.gold);
    }
    else
...
static void _prep_input()
{
    ...
    if (you.seen_portals)
    {
        ...
        mprf(MSGCH_GOD,
             P_("You have a vision of a gate.",
                "You have a vision of multiple gates.", you.seen_portals));
...
static void _decrement_durations()
{
    ...
    if (last_value > 0)
    {
        ...
        if (you.duration[DUR_WEAPON_BRAND] <= 0)
        {
            ...
            mprf(MSGCH_DURATION, msg, weapon.name(DESC_YOUR).c_str());
